            ...
            init = function() {
                ...
                objBook.children().each(function(i){
                    ...
                    if (vCouples.length == 0) {
                        $(this).append('<button onclick="gotoPage('+iPage+')">下一頁</button>');
                    }
                    if (vCouples.length == 1) {
                        $(this).append('<button onclick="gotoPage('+(iPage-1)+')">上一頁</button>');
                    }
                    vCouples.push(this);
                ...
                if (vCouples.length == 1) {
                    vCouples.push($('<div class="side"><h2>結束</h2><button onclick="gotoPage('+(iPage-1)+')">上一頁</button></div>')[0]);
                    vPages.push(vCouples);
                }
